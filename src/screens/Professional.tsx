            ...
            <TableContainer>
              ...
              <TableRoleContainer>
                ...
                <TableUl>
                  ...
                  <TableLi>
                    Performing code reviews on PRs submitted by other
                    developers;
                  </TableLi>
                  <TableLi>
            ...
            <TableContainer>
              <TableTechStackContainer>
                ...
                <TableUl>
                  ...
                  <TableLi>
                    Headless CMSs such as Strapi and Contentful;
                  </TableLi>
              ...
              <TableRoleContainer>
                ...
                <TableUl>
                  <TableLi>
                    ...
                    architects, clients, product owners, UI/UX designers to
                    build and maintain various large websites and web apps for
                    clients;
                  </TableLi>
                  <TableLi>
            ...
            <TableContainer>
              ...
              <TableRoleContainer>
                ...
                <TableUl>
                  ...
                  <TableLi>
                    Implemented A/B testing to test new variations of
                    components, to track improved user engagement and
                    interactions;
                  </TableLi>
                  <TableLi>
                    Worked in an Agile environment with many business
                    stakeholders to ensure swift, timely releases were met.
                  </TableLi>
                </TableUl>
              </TableRoleContainer>
            </TableContainer>
              ...
              <TableRoleContainer>
                ...
                <TableUl>
                  ...
                  <TableLi>
                    ...
                    parents, external pedagogical and healthcare professionals
                  ...
                  <TableLi>
                    Both participated in and delivered training on a wide
                    variety of teaching topics, such as mathematical training
                    and safeguarding training, to ensure the training and
                    awareness of safeguarding of myself and my colleagues were
                    always up-to-date.
                  </TableLi>
                </TableUl>
              </TableRoleContainer>
